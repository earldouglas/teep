 ...
 * @param promises An array of Promise instances or Promise-returning functions
 * @param callback A function that takes as arguments the results of the promises
 */
