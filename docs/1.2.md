...
```html
<script src="https://github.com/earldouglas/teep/raw/1.2.0/teep.js"></script>
...
`throttle` limits the rate of application of a function `f`, regardless of how frequently it is called.
...
* `f` is a zero-argument function to be throttled
...
```javascript
// Don't exceed two f() calls per second
var limit = 2;
var period = 1000;

// Space out f() calls with 250ms in between
var interval = 250;
